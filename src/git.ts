...
const SOURCE_RE = /\.(ts|tsx|mts|cts|js|jsx|mjs|cjs|java)$/;
const SKIP_RE =
  /(^|\/)(node_modules|dist|build|out|coverage|\.next|vendor|cdk\.out|\.serverless|__generated__|target|\.gradle|generated-sources)(\/|$)|\.d\.ts$|\.min\.js$/;
